...
import { RACUN_URL, RACUN_KLIJENT_URL } from './../app.constants';
...
export class RacunService {
  ...
  public getRacunKlijent(idKlijenta: number): Observable<any> {
    return this.httpClient.get(`${RACUN_KLIJENT_URL}/${idKlijenta}`);
  }
